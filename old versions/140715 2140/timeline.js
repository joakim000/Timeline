...
var RIGHTMARGIN = 40; //Avoid horiz scrollbar when vertical scrollbar appears
...
function timeAxis(low, high, expandFactor){
	...
	*/
	/*
		...
		yearL.setAttributeNS(null, 'font-size', '26'); 
		yearL.setAttributeNS(null, 'fill', '#666');
		yearL.setAttributeNS(null, 'stroke', 'lightblue');
	...
	tl.appendChild(yearL);
		...
		yearR.setAttributeNS(null, 'font-size', '26');
		yearR.setAttributeNS(null, 'fill', '#666');
		yearR.setAttributeNS(null, 'stroke', 'lightblue');
		yearR.setAttributeNS(null, 'x', tlWidth + MARGIN - 73);
